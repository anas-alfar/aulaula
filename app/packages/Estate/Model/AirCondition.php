 ...
 * @package Estate
 * @subpackage Model
 * @name Estate_Model_AirCondition
...
class Estate_Model_AirCondition extends Aula_Model_DbTable {

	protected $_name = 'estate_air_condition';
	...
	public function getAllAirCondition_OrderByColumnWithLimit( $column, $sorting, $start, $limit ) 
	{
		$start = ( int )($start);
		$limit = ( int )($limit);
	...
	public function getAllAirCondition( ) 
	{
		$result = $this 
		-> select() 
		-> from($this->_name, new Zend_Db_Expr('SQL_CALC_FOUND_ROWS *'))/* ->    where ('id > ?', 1)*/ 
	...
	public function getAirConditionById( $id ) 
	{
		$id = (int) $id;
		$result = $this 
		-> select() 
	...
	public function getAllAirConditionByLocaleId( $locale_id ) 
	{
