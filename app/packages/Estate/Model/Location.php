...
class Estate_Model_Location extends Aula_Model_DbTable {

	protected $_name = 'estate_location';
	...
	public function getAllLocation_OrderByColumnWithLimit( $column, $sorting, $start, $limit ) 
	{
		$start = ( int )($start);
		$limit = ( int )($limit);
	...
	public function getAllLocationByLocaleId( $locale_id ) 
	{
