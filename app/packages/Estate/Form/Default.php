...
class Estate_Form_Default extends Zend_Dojo_Form
{
	public $view = NULL;
	...
	public function renderForm() {
		...
		$videoForm->addElement(
			...
			array(
				'required'	=> true,
		    	'label'     => $this -> view -> __ ( 'Real_Estate_Thumb' ),
		    	'validators'=> array(
		...
		$videoForm->addElement(
			...
			array(
				'required'	=> true,
		    	'label'         => $this -> view -> __ ( 'Real_Estate_Video' ),
		    	'validators'    => array(
		    		array('ExcludeExtension', false, array('php', 'exe', 'case' => true)),
		...
		$photoForm->setAttribs(array(
            'name'	=> 'photo',
            'dijitParams' => array(
                'title' => $this-> view -> __ ( 'Real_Estate_Photo' ),
            )
		));
		...
		array(
			'required'	=> true,
			'label' => $this -> view -> __ ( 'Real_Estate_Upload_Photo_1' ),
			'id'	=> 'photo_1',
			'name' => 'photo_1',
			'validators' => 
			array(
		...
		'photo_2',
		array(
			'label' => $this -> view -> __ ( 'Real_Estate_Upload_Photo_2' ),
			'id'	=> 'photo_2',
			'name' => 'photo_2',
			'validators' => 
			array(
		...
		'photo_3',
		array(
			'label' => $this -> view -> __ ( 'Real_Estate_Upload_Photo_3' ),
			'id'	=> 'photo_3',
			'name' => 'photo_3',
			'validators' => 
			array(
		...
		'photo_4',
		array(
			'label' => $this -> view -> __ ( 'Real_Estate_Upload_Photo_4' ),
			'id'	=> 'photo_4',
			'name' => 'photo_4',
			'validators' => 
			array(
		...
		'photo_5',
		array(
			'label' => $this -> view -> __ ( 'Real_Estate_Upload_Photo_5' ),
			'id'	=> 'photo_5',
			'name' => 'photo_5',
			'validators' => 
			array(
		...
		'photo_6',
		array(
			'label' => $this -> view -> __ ( 'Real_Estate_Upload_Photo_6' ),
			'id'	=> 'photo_6',
			'name' => 'photo_6',
			'validators' => 
			array(
		...
		'photo_7',
		array(
			'label' => $this -> view -> __ ( 'Real_Estate_Upload_Photo_7' ),
			'id'	=> 'photo_7',
			'name' => 'photo_7',
			'validators' => 
			array(
		...
		'photo_8',
		array(
			'label' => $this -> view -> __ ( 'Real_Estate_Upload_Photo_8' ),
			'id'	=> 'photo_8',
			'name' => 'photo_8',
			'validators' => 
			array(
		...
		'photo_9',
		array(
			'label' => $this -> view -> __ ( 'Real_Estate_Upload_Photo_9' ),
			'id'	=> 'photo_9',
			'name' => 'photo_9',
			'validators' => 
			array(
		...
		'photo_10',
		array(
			'label' => $this -> view -> __ ( 'Real_Estate_Upload_Photo_10' ),
			'id'	=> 'photo_10',
			'name' => 'photo_10',
			'validators' => 
			array(
