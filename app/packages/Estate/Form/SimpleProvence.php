...
*
* @category Aula
* @package Aula_Estate_Form_SimpleProvence
...
class Estate_Form_SimpleProvence extends Zend_Dojo_Form
{
	public $view = NULL;
	...
	private function _getEstateLocationOptions($locale_id) {
    ...
    public function init()
    {
        ...
        $mandatoryForm->addElement(
            ...
            array(
                ...
                'autocomplete'=>false,
                'required'	=> true,
                'multiOptions' => $this->_getEstateLocationOptions($this -> locale_id),
                'id' => 'estate_location_id',
