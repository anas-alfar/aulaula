...
*
* @category Aula
* @package Aula_Estate_Form_SimpleLocation
...
class Estate_Form_SimpleLocation extends Zend_Dojo_Form
{
	public $view = NULL;
	//private $_selectEstateTypeOptions = array();
	...
	/*private function _getEstateTypeOptions() {
		...
		$estateTypeObjResult 	= $estateTypeObj -> select() -> query() -> fetchAll();
		if (!empty($estateTypeObjResult)) {
			foreach ($estateTypeObjResult as $key => $value) {
				$this->_selectEstateTypeOptions[$value['id']] = $value['title'];
			}
		}
		return $this->_selectEstateTypeOptions;
	}*/
    ...
    public function init()
    {
        ...
        /*$mandatoryForm->addElement(
            ...
            'estate_type_id',
            array(
                'label' => $this-> view -> __ ( 'Estate_Type' ),
                'class' => 'lablvalue jstalgntop',
                'autocomplete'=>false,
                'required'	=> true,
                //'validator' => array('NotEmpty', true),
                'multiOptions' => $this->_getEstateTypeOptions(),
                'id' => 'estate_type_id',
