 ...
 * @package Landlots
 * @subpackage Form
 * @name Landlots_Form_SimpleProvence
...
class Landlots_Form_SimpleProvence extends Zend_Dojo_Form
{
	public $view = NULL;
	...
	private function _getLandlotsLocationOptions($locale_id) {
    ...
    public function init()
    {
        ...
        $mandatoryForm->addElement(
            ...
            array(
                ...
                'multiOptions' => $this->_getLandlotsLocationOptions($this -> locale_id),
