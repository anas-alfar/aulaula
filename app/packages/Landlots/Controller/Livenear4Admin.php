 ...
 * @name Landlots_Controller_Livenear4Admin
...
class Landlots_Controller_Livenear4Admin extends Aula_Controller_Action {
	...
	public function viewAction() {
		if ( isset($_GET['id']) and is_numeric($_GET['id']) ) {
			$result = $this -> livenear4Obj -> getLivenear4ById($_GET['id']);
			$this -> view -> result = $result;
			$this -> view -> render('landlots/viewLivenear4.phtml');
			exit();
		}
	}
	...
	public function editAction() {
		$form = new Landlots_Form_SimpleLivenear4($this -> view);
		$form -> setView($this -> view);
