...
class Landlots_Model_Livenear2 extends Aula_Model_DbTable {

	protected $_name = 'landlots_livenear_2';
	...
	public function getAllLivenear2_OrderByColumnWithLimit( $column, $sorting, $start, $limit ) 
	{
		$start = ( int )($start);
		$limit = ( int )($limit);
	...
	public function getAllLivenear2( ) 
	{
		$result = $this 
		-> select() 
		-> from($this->_name, new Zend_Db_Expr('SQL_CALC_FOUND_ROWS *'))/* ->    where ('id > ?', 1)*/ 
	...
	public function getAllLivenear2ByLocalId( $locale_id ) 
	{
