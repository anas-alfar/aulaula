...
class Landlots_Model_Livenear4 extends Aula_Model_DbTable {

	protected $_name = 'landlots_livenear_4';
	...
	public function getAllLivenear4_OrderByColumnWithLimit( $column, $sorting, $start, $limit ) 
	{
		$start = ( int )($start);
		$limit = ( int )($limit);
	...
	public function getAllLivenear4( ) 
	{
		$result = $this 
		-> select() 
		-> from($this->_name, new Zend_Db_Expr('SQL_CALC_FOUND_ROWS *'))/* ->    where ('id > ?', 1)*/ 
	...
	public function getLivenear4ById( $id ) 
	{
		$id = (int) $id;
		$result = $this 
		-> select() 
	...
	public function getAllLivenear4ByLocalId( $locale_id ) 
	{
