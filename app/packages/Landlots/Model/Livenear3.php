...
class Landlots_Model_Livenear3 extends Aula_Model_DbTable {

	protected $_name = 'landlots_livenear_3';
	...
	public function getAllLivenear3_OrderByColumnWithLimit( $column, $sorting, $start, $limit ) 
	{
		$start = ( int )($start);
		$limit = ( int )($limit);
	...
	public function getAllLivenear3( ) 
	{
		$result = $this 
		-> select() 
		-> from($this->_name, new Zend_Db_Expr('SQL_CALC_FOUND_ROWS *'))/* ->    where ('id > ?', 1)*/ 
	...
	public function getLivenear3ById( $id ) 
	{
		$id = (int) $id;
		$result = $this 
		-> select() 
	...
	public function getAllLivenear3ByLocalId( $locale_id ) 
	{
