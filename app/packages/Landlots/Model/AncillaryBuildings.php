 ...
 * @package Landlots
 * @subpackage Model
 * @name Landlots_Model_AncillaryBuildings
...
class Landlots_Model_AncillaryBuildings extends Aula_Model_DbTable {

	protected $_name = 'landlots_ancillary_buildings';
	...
	public function getAllAncillaryBuildings_OrderByColumnWithLimit( $column, $sorting, $start, $limit ) 
	{
		$start = ( int )($start);
		$limit = ( int )($limit);
	...
	public function getAllAncillaryBuildings( ) 
	{
		$result = $this 
		-> select() 
		-> from($this->_name, new Zend_Db_Expr('SQL_CALC_FOUND_ROWS *'))/* ->    where ('id > ?', 1)*/ 
	...
	public function getAllAncillaryBuildingByLocalId( $locale_id ) 
	{
