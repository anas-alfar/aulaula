...
class Landlots_Model_Livenear1 extends Aula_Model_DbTable {

	protected $_name = 'landlots_livenear_1';
	...
	public function getAllLivenear1_OrderByColumnWithLimit( $column, $sorting, $start, $limit ) 
	{
		$start = ( int )($start);
		$limit = ( int )($limit);
	...
	public function getAllLivenear1( ) 
	{
		$result = $this 
		-> select() 
		-> from($this->_name, new Zend_Db_Expr('SQL_CALC_FOUND_ROWS *'))/* ->    where ('id > ?', 1)*/ 
	...
	public function getLivenear1ById( $id ) 
	{
		$id = (int) $id;
		$result = $this 
		-> select() 
	...
	public function getAllLivenear1ByLocalId( $locale_id ) 
	{
