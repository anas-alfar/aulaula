...
class Vehicle_Model_BodyColor extends Aula_Model_DbTable {

	protected $_name = 'vehicle_body_color';
	...
	public function getAllBodyColor_OrderByColumnWithLimit( $column, $sorting, $start, $limit ) 
	{
		$start = ( int )($start);
		$limit = ( int )($limit);
	...
	public function getAllBodyColor( ) 
	{
		$result = $this 
		-> select() 
		-> from($this->_name, new Zend_Db_Expr('SQL_CALC_FOUND_ROWS *'))/* ->    where ('id > ?', 1)*/ 
	...
	public function getAllBodyColorByLocalId( $locale_id ) 
	{
	...
	public function getBodyColorById( $id ) 
	{
		$id = (int) $id;
		$result = $this 
		-> select() 
