 ...
 * @package Vehicle
 * @subpackage Model
 * @name Vehicle_Model_InsideColor
...
class Vehicle_Model_InsideColor extends Aula_Model_DbTable {

	protected $_name = 'vehicle_inside_color';
	...
	public function getAllInsideColor_OrderByColumnWithLimit( $column, $sorting, $start, $limit ) 
	{
		$start = ( int )($start);
		$limit = ( int )($limit);
	...
	public function getAllInsideColor( ) 
	{
		$result = $this 
		-> select() 
		-> from($this->_name, new Zend_Db_Expr('SQL_CALC_FOUND_ROWS *'))/* ->    where ('id > ?', 1)*/ 
	...
	public function getAllInsideColorByLocalId( $locale_id ) 
	{
	...
	public function getInsideColorById( $id ) 
	{
		$id = (int) $id;
		$result = $this 
		-> select() 
