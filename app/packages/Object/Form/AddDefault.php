...
class Object_Form_AddDefault extends Zend_Dojo_Form
{
	public $view = NULL;
    ...
    public function init()
    {
		...
		$flag = true;
		foreach ($this->_getLocaleAvailabe() as $id => $locale) {

		// Begin Article Form
        $articleForm = new Zend_Dojo_Form_SubForm();
        $articleForm->setAttribs(array(
                'name'			=> $locale['id'],  //'article',
                'legend' 		=> 'article',
                'dijitParams' 	=> array(
                    'title' 	=> $this-> view -> __ ( $locale['title'] . ' ' . 'Object_Article' ),
                )
        ));
		...
		$this->addSubForm($articleForm	, $locale['id'] /*'article'*/);
		// End Article Form
		...
		foreach (array(1,2,3) as $value) {
	        ...
	        $photoForm->setAttribs(array(
	                'name'			=> 'photo_' . $locale['id'] . '_'  . $value,
	                'dijitParams' 	=> array(
	                    'title' 	=> $this-> view -> __ ( $locale['title'] . ' ' . 'Object_Photo' ) . ' ' . $value,
	                )
	        ));
			...
			$photoForm->getElement('photo_' . $locale['id'] .'_'. $value)-> setDecorators(
	    	array(
	        	'File',
		        'Errors',
		        array(array('data' => 'HtmlTag'), array('tag' => 'td', 'class' => 'lable jstalgntop')),
			...
			$this->addSubForm($photoForm 	, 'photo_' . $locale['id'] . '_' . $value);
        }
        ...
        $videoForm->setAttribs(array(
                'name'			=> 'video_' . $locale['id'],  //'video',
                'legend' 		=> 'video',
                'dijitParams' 	=> array(
                    'title' 	=> $this-> view -> __ ( $locale['title'] . ' ' . 'Object_Video' ),
                )
        ));
        ...
        $fileForm->setAttribs(array(
                'name'			=> 'file_' . $locale['id'],
                'legend' 		=> 'file',
                'dijitParams' 	=> array(
                    'title' 	=> $this-> view -> __ ( $locale['title'] . ' ' . 'Object_Files' ),
                )
        ));
        $fileForm->addElement(
                'TextBox',
        ...
        $optionalForm->setAttribs(array(
                    'name' 	 => 'optional_' . $locale['id'],
                    'legend' => $this-> view -> __ ( $locale['title'] . ' ' . 'Object_Advanced' ),
        ));
        ...
        $metaForm->setAttribs(array(
                    'name' 	 => 'meta_' . $locale['id'],
                    'legend' => $this-> view -> __ ( $locale['title'] . ' ' . 'Object_Meta Data' ),
        ));
        $metaForm->addElement(
                'TextBox',
                'page_title',
		...
		$videoForm->getElement('video_' . $locale['id'])-> setDecorators(
	    array(
	        'File',
	        'Errors',
	        array(array('data' => 'HtmlTag'), array('tag' => 'td', 'class' => 'lable jstalgntop')),
		...
		$videoForm->getElement('videoThumb_' . $locale['id'])-> setDecorators(
	    array(
	        'File',
	        'Errors',
	        array(array('data' => 'HtmlTag'), array('tag' => 'td', 'class' => 'lable jstalgntop')),
		...
		$fileForm->getElement('file_' . $locale['id'])-> setDecorators(
	    array(
	        'File',
	        'Errors',
	        array(array('data' => 'HtmlTag'), array('tag' => 'td', 'class' => 'lable jstalgntop')),
        ...
        $this->addSubForm($videoForm	, 'video_' . $locale['id'])
             ->addSubForm($fileForm		, 'file_' . $locale['id'])
             ->addSubForm($optionalForm , 'optional_' . $locale['id'])
			 ->addSubForm($metaForm 	, 'meta_' . $locale['id']);
		}
    }
}