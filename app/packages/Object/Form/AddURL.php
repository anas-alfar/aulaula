...
class Object_Form_AddURL extends Zend_Dojo_Form
{
	public $view = NULL;
    ...
    public function init()
    {
        ...
        $mandatoryForm->setAttribs(array(
                ...
                'legend' 		=> 'mandatory',
                'dijitParams' 	=> array(
                    'title' 	=> $this-> view -> __ ( $value['title'] . ' ' .	 'Object_URL' ),
                )
        ));
        ...
        $mandatoryForm->addElement(
                ...
                'style',
                array(
                    'label' 	=> $this-> view -> __ ( 'Object_Styel' ),
                    'trim' 		=> true,
                    'class' 	=> 'lablvalue jstalgntop',
                )
        );
        $mandatoryForm->addElement(
	            ...
	            'url_type',
	            array(
	                'label' => $this-> view -> __ ( 'Object_URL Type' ),
	                'class' => 'lablvalue jstalgntop',
	                'autocomplete'=>false,
	                'required'	=> true,
	                'multiOptions' => array ('Link' => 'Link', 'Iframe' => 'Iframe', 'YouTube' => 'YouTube'),
	                //'id' => 'url_type',
	            )
        );
		$mandatoryForm->addElement(
        ...
        $metaForm->setAttribs(array(
                    'name' 	 => 'meta_' . $value['id'],
                    'legend' => $this-> view -> __ ( $value['title'] . ' ' . 'Object_Meta Data' ),
        ));
        $metaForm->addElement(
                'TextBox',
                'page_title',
        ...
        $this->addSubForm($mandatoryForm, $value['id'])
			 ...
			 ->addSubForm($metaForm 	, 'meta_' . $value['id']);
		}
    }
}