...
class Object_Form_AddFile extends Zend_Dojo_Form
{
	public $view = NULL;
    ...
    public function init()
    {
        ...
        $mandatoryForm->setAttribs(array(
                ...
                'legend' 		=> 'mandatory',
                'dijitParams' 	=> array(
                    'title' 	=> $this-> view -> __ ( $value['title'] . ' ' . 'Object_Files' ),
                )
        ));
		...
		$mandatoryForm->getElement( 'uploadFile_' . $value['id'] )-> setDecorators(
	    array(
	        'File',
	        'Errors',
	        array(array('data' => 'HtmlTag'), array('tag' => 'td', 'class' => 'lable jstalgntop')),
