...
class Object_Model_File extends Aula_Model_DbTable {
	...
	public function __construct() {
		$this->cols = $this->_cols = array ('id', 'name', 'label', 'description', 'folder_id', 'author_id', 'mime_type', 'size', 'extension', 'full_path', 'object_id', 'category_id', 'show_in_object', 'published', 'approved', 'locked_by', 'locked_time', 'modified_by', 'modified_time', 'date_added', 'comments', 'options' );
		$this->_selectColumnsList = ' SQL_CALC_FOUND_ROWS `id`, `name`, `label`, `description`, `folder_id`, `author_id`, `mime_type`, `size`, `extension`, `full_path`, `object_id`, `category_id`, `show_in_object`, `published`, `approved`, `locked_by`, `locked_time`, `modified_by`, `modified_time`, `date_added`, `comments`, `options` ';
		parent::__construct ();
	}
