...
class Package_Model_Default extends Aula_Model_DbTable {
	...
	public function __construct() {
		$this->cols = $this->_cols = $this->columns = array ('id', 'title', 'label', 'show_in_menu', 'published', 'approved', 'type', 'prerequisite_id' );
		$this->_selectColumnsList = ' SQL_CALC_FOUND_ROWS `id`, `title`, `label`, `show_in_menu`, `published`, `approved`, `type`, `prerequisite_id` ';
		parent::__construct ();
	}
