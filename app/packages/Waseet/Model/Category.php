...
class Waseet_Model_Category extends Aula_Model_DbTable {

	protected $_name = 'waseet_category';
	...
	public function getAllCategory_OrderByColumnWithLimit( $column, $sorting, $start, $limit ) 
	{
		$start = ( int )($start);
		$limit = ( int )($limit);
