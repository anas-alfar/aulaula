...
class Waseet_Form_Category extends Zend_Dojo_Form
{
	public $view = NULL;
    ...
    public function init()
    {
        ...
        $mandatoryForm->setAttribs(array(
                ...
                //'legend' 		=>  $id,
                'dijitParams' 	=> array(
                    'title' 	=> $this-> view -> __ ( $value['title'] . ' Waseet_Information' ),
                )
        ));
        $mandatoryForm->addElement(
                ...
                'title',
                array(
                    'label' 	=> $this-> view -> __ ( 'Waseet_Title' ),
                    'trim' 		=> true,
                    'required'	=> true,
        ...
        $mandatoryForm->addElement(
                ...
                'description',
                array(
                    'label' 	=> $this-> view -> __ ( 'Waseet_Description' ),
                    'trim' 		=> true,
                    'required'	=> true,
                    'class' 	=> 'lablvalue jstalgntop',
                )
		...
		if ($flag === true) {
	        ...
	        $mandatoryForm->addElement(
				...
				array(
					'value'		=> 'submit',
					'label' 	=> $this-> view -> __ ( 'Waseet_Save' ),
					'type'	 	=> 'Submit',
					'ignore'	=> true,
        ...
        $optionalForm->setAttribs(array(
                    ...
                    'legend' => $this-> view -> __ ( $value['title'] . ' Waseet_Advanced Settings' ),
        ));
        $optionalForm->addElement(
                'TextBox',
                'comments',
                array(
                    'label' 	=> $this-> view -> __ ( 'Waseet_Comments' ),
                    'trim' 		=> true,
                    'class' 	=> 'lablvalue jstalgntop',
                	)
            );
        $optionalForm->addElement(
                ...
                'options',
                array(
                    'label' 	=> $this-> view -> __ ( 'Waseet_Options' ),
                    'trim' 		=> true,
                    'class' 	=> 'lablvalue jstalgntop',
                	)
            );
