 ...
 * @package Aula_Waseet
 * @subpackage Form
 * @name Waseet_Form_SimpleCategory
...
class Waseet_Form_SimpleCategory extends Zend_Dojo_Form
{
	public $view = NULL;
    ...
    public function init()
    {
        ...
        $mandatoryForm->setAttribs(array(
                ...
                'legend' 		=> 'mandatory',
                'dijitParams' 	=> array(
                    'title' 	=> $this-> view -> __ ( 'Waseet_Information' ),
                )
        ));
        ...
        $optionalForm->setAttribs(array(
                    'name' 	 => 'optional',
                    'legend' => $this-> view -> __ ( 'Waseet_Advanced Settings' ),
                ));
